...
| 模型规模 | 首选实例 | 备选实例 | 经济型 |
|---------|---------|---------|--------|
| 超大模型 (>1T) | p6.48xlarge | p5en.48xlarge | - |
| 大型模型 (100B-1T) | p5en.48xlarge | p5.48xlarge | p4d.24xlarge |
| 中型模型 (10B-100B) | p5.48xlarge | p4d.24xlarge | trn1.32xlarge |
| 小型模型 (<10B) | p4d.24xlarge | trn1.32xlarge | p3.16xlarge |
